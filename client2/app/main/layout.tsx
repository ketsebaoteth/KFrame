...
export default function MainLayout({
  ...
  return (
    <html lang="en" suppressHydrationWarning className="">
      <head />
      <body
        className={`${spaceGrotesk} antialiased flex  overflow-x-hidden dark:bg-black bg-white`}
      >
        <script
        ...
        >
          <div className="md:flex md:flex-row flex flex-col dark:bg-black bg-white w-full">
            {/* Desktop Navigation */}
            <div className="md:w-[13vw] hidden md:block border-r border-foreground/20 border-dashed">
